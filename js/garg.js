...
'http://seedspills.com/' + domain,
'http://whoisx.co.uk/' + domain,
'http://www.whoisya.com/' + domain,
'http://www.bhawanigarg.com/' + domain,
'http://dntrace.keyhints.com/' + domain,
'http://www.peekstats.com/' + domain,
'http://peekstats.com/' + domain,
...
newDiv.innerHTML = '<li id="shit1">'+i+'.&nbsp;&nbsp;<b> Failed</b> - <A href="'+urls[i]+'" target="_blank" class="linkcss"><font size="1px">'+urls[i]+'</font></A> <br><img src="http://file.pakteguh.com/img/error.png" border="0">&nbsp;<b>Page Creation Failed !</b></li>';
...
if(matchPos1 != -1){
newDiv = document.createElement("div");
newDiv.innerHTML = '<li id="shit2">'+i+'.&nbsp;&nbsp;<b> OK</b> - <A href="'+urls[i]+'" target="_blank" class="linkcss"><font size="1px">'+urls[i]+'</font></A> <br><img src="http://file.pakteguh.com/img/ok.png" border="0">&nbsp;<b>Page Created And Pinged !</b></li>';
my_div = document.getElementById("xmlObj");
my_div.parentNode.insertBefore(newDiv, my_div);
i++
getthem();
...
error:function (){
newDiv = document.createElement("div");
newDiv.innerHTML = '<li id="shit2">'+i+'.&nbsp;&nbsp;<b> OK</b> - <A href="'+urls[i]+'" target="_blank" class="linkcss"><font size="1px">'+urls[i]+'</font></A> <br><img src="http://file.pakteguh.com/img/error.png" border="0">&nbsp;<b>Page Created And Ping Failed !</b></li>';
my_div = document.getElementById("xmlObj");
my_div.parentNode.insertBefore(newDiv, my_div);
i++
getthem();
